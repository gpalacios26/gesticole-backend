...
public class PdfGeneratorPersonal {

	private static final Logger logger = LoggerFactory.getLogger(PdfGeneratorPersonal.class);

	public static ByteArrayInputStream objetoToPdf(Personal personal, String basePath) throws IOException {
		...
		try {
			...
			PdfPCell cell_title;
			cell_title = new PdfPCell(new Phrase("FICHA DE PERSONAL", titleFont));
			...
			if(personal.getFoto() == null) {
				if(personal.getSexo().getIdSexo() == 1) {
				...
				File file = new File(basePath+personal.getFoto());
			...
			cell_1 = new PdfPCell(new Phrase(personal.getIdPersonal().toString()));
			cell_1.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_1.setPadding(5);
			contenido.addCell(cell_1);
			...
			cell_2 = new PdfPCell(new Phrase(personal.getNombres()));
			cell_2.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_2.setPadding(5);
			contenido.addCell(cell_2);
			...
			cell_3 = new PdfPCell(new Phrase(personal.getApellidos()));
			cell_3.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_3.setPadding(5);
			contenido.addCell(cell_3);
			...
			cell_4 = new PdfPCell(new Phrase(personal.getTipoDocumento().getDescripcion()));
			cell_4.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_4.setPadding(5);
			contenido.addCell(cell_4);
			...
			cell_5 = new PdfPCell(new Phrase(personal.getNumDocumento()));
			cell_5.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_5.setPadding(5);
			contenido.addCell(cell_5);
			...
			cell_6 = new PdfPCell(new Phrase(personal.getFechaNac().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
			cell_6.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_6.setPadding(5);
			contenido.addCell(cell_6);
			...
			cell_7 = new PdfPCell(new Phrase(personal.getSexo().getDescripcion()));
			cell_7.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_7.setPadding(5);
			contenido.addCell(cell_7);
			...
			cell_8 = new PdfPCell(new Phrase(personal.getTelCelular()));
			cell_8.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_8.setPadding(5);
			contenido.addCell(cell_8);
			...
			cell_9 = new PdfPCell(new Phrase(personal.getTelFijo()));
			cell_9.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_9.setPadding(5);
			contenido.addCell(cell_9);
			...
			cell_10 = new PdfPCell(new Phrase(personal.getCorreo()));
			cell_10.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_10.setPadding(5);
			contenido.addCell(cell_10);
			
			PdfPCell cell_11;
			cell_11 = new PdfPCell(new Phrase("Tipo Cargo", tableHeadFont));
			...
			cell_11 = new PdfPCell(new Phrase(personal.getTipoPersonal().getDescripcion()));
			cell_11.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_11.setPadding(5);
			contenido.addCell(cell_11);
			
			PdfPCell cell_12;
			cell_12 = new PdfPCell(new Phrase("Cargo", tableHeadFont));
			...
			cell_12 = new PdfPCell(new Phrase(personal.getCargo()));
			cell_12.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_12.setPadding(5);
			contenido.addCell(cell_12);
