...
public class PdfGeneratorAlumno {

	private static final Logger logger = LoggerFactory.getLogger(PdfGeneratorAlumno.class);

	public static ByteArrayInputStream objetoToPdf(Alumno alumno, String basePath) throws IOException {
		...
		try {
			...
			PdfPCell cell_title;
			cell_title = new PdfPCell(new Phrase("FICHA DE ALUMNO", titleFont));
			...
			if(alumno.getFoto() == null) {
				...
				File file = new File(basePath+alumno.getFoto());
			...
			cell_1 = new PdfPCell(new Phrase(alumno.getIdAlumno().toString()));
			cell_1.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_1.setPadding(5);
			contenido.addCell(cell_1);
			...
			cell_2 = new PdfPCell(new Phrase(alumno.getNombres()));
			cell_2.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_2.setPadding(5);
			contenido.addCell(cell_2);
			...
			cell_3 = new PdfPCell(new Phrase(alumno.getApellidos()));
			cell_3.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_3.setPadding(5);
			contenido.addCell(cell_3);
			...
			cell_4 = new PdfPCell(new Phrase(alumno.getTipoDocumento().getDescripcion()));
			cell_4.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_4.setPadding(5);
			contenido.addCell(cell_4);
			...
			cell_5 = new PdfPCell(new Phrase(alumno.getNumDocumento()));
			cell_5.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_5.setPadding(5);
			contenido.addCell(cell_5);
			...
			cell_6 = new PdfPCell(new Phrase(alumno.getFechaNac().format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
			cell_6.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_6.setPadding(5);
			contenido.addCell(cell_6);
			...
			cell_7 = new PdfPCell(new Phrase(alumno.getSexo().getDescripcion()));
			cell_7.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_7.setPadding(5);
			contenido.addCell(cell_7);
			...
			cell_8 = new PdfPCell(new Phrase(alumno.getTelCelular()));
			cell_8.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_8.setPadding(5);
			contenido.addCell(cell_8);
			...
			cell_9 = new PdfPCell(new Phrase(alumno.getTelFijo()));
			cell_9.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_9.setPadding(5);
			contenido.addCell(cell_9);
			...
			cell_10 = new PdfPCell(new Phrase(alumno.getCorreo()));
			cell_10.setHorizontalAlignment(Element.ALIGN_LEFT);
			cell_10.setPadding(5);
			contenido.addCell(cell_10);
